<template>
    <Modal
        ...
        :title="title"
        width="500"
        class-name="vertical-center-modal form-change-password"
    ...
    >
        <Form
            ...
            :label-width="180"
        >
            <FormItem label="Mật khẩu mới" prop="password">
                <Input
            ...
            <FormItem label="Xác nhận mật khẩu mới" prop="rePassword">
                <Input
        ...
        handleSubmit() {
            this.$refs.form.validate(async (valid) => {
                try {
                    if (valid) {
                        this.loading = true
                        const sourceApi = `${this.$api.USER}${this.formState.id}/`
                        await this.$axios.$patch(sourceApi, {
                            ...this.formState,
                        })
